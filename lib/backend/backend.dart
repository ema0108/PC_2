...
import 'schema/califications_record.dart';
...
export 'schema/califications_record.dart';
...
/// Functions to query CalificationsRecords (as a Stream and as a Future).
Future<int> queryCalificationsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CalificationsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CalificationsRecord>> queryCalificationsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CalificationsRecord.collection,
      CalificationsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CalificationsRecord>> queryCalificationsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
