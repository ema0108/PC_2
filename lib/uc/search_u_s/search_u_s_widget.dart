...
import 'search_u_s_model.dart';
export 'search_u_s_model.dart';

class SearchUSWidget extends StatefulWidget {
  const SearchUSWidget({super.key});

  @override
  State<SearchUSWidget> createState() => _SearchUSWidgetState();
}

class _SearchUSWidgetState extends State<SearchUSWidget>
    with TickerProviderStateMixin {
  late SearchUSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchUSModel());
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    isDense: false,
                    labelText: 'Buscar staff de soporte...',
                    labelStyle:
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Búsqueda de soporte coincidentes',
