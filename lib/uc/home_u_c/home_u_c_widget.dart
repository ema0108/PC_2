...
import 'home_u_c_model.dart';
export 'home_u_c_model.dart';

class HomeUCWidget extends StatefulWidget {
  const HomeUCWidget({super.key});

  @override
  State<HomeUCWidget> createState() => _HomeUCWidgetState();
}

class _HomeUCWidgetState extends State<HomeUCWidget>
    with TickerProviderStateMixin {
  late HomeUCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeUCModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ReportsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReportsRecord> homeUCReportsRecordList = snapshot.data!;
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    16.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  'A continuación se muestra un resumen de tu día.',
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: 'Plus Jakarta Sans',
                                        ...
                                        child: Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  homeUCReportsRecordList.length
                                                      .toString(),
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 4.0, 0.0, 0.0),
                                            child: Text(
                                              'Un resumen de los ultimos reportes.',
                                              style:
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      16.0, 4.0, 0.0, 0.0),
                                  child: Text(
                                    'A continuación se muestra una descripción general de los reportes y reportes calificados.',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Plus Jakarta Sans',
