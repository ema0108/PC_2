...
import 'reports_u_c_model.dart';
export 'reports_u_c_model.dart';

class ReportsUCWidget extends StatefulWidget {
  const ReportsUCWidget({super.key});

  @override
  State<ReportsUCWidget> createState() => _ReportsUCWidgetState();
}

class _ReportsUCWidgetState extends State<ReportsUCWidget>
    with TickerProviderStateMixin {
  late ReportsUCModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReportsUCModel());
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Container(
                                                height: 32.0,
                                                decoration: BoxDecoration(
                                                  color: const Color(0x4D89F592),
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          12.0),
                                                  border: Border.all(
                                                    color: const Color(0xFF61EF6D),
                                                    width: 2.0,
                                                  ),
                                                ),
                                                child: Align(
