...
import 'home_u_s_model.dart';
export 'home_u_s_model.dart';

class HomeUSWidget extends StatefulWidget {
  const HomeUSWidget({super.key});

  @override
  State<HomeUSWidget> createState() => _HomeUSWidgetState();
}

class _HomeUSWidgetState extends State<HomeUSWidget>
    with TickerProviderStateMixin {
  late HomeUSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeUSModel());
            ...
            children: [
              Padding(
                ...
                child: FutureBuilder<int>(
                  future: queryReportsRecordCount(
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(16.0, 12.0, 16.0, 44.0),
                child: StreamBuilder<List<ReportsRecord>>(
                  stream: queryReportsRecord(
                    limit: 1,
                  ),
